...
#load(paste("Results/np.",NpMethod,".",year.red,".RData", sep=""))
summary(bw.f)
@
...
save(np.f.sig,  file = paste("Results/sig.f.",NpMethod,".",year.red,".RData", sep=""))
...
#load(paste("Results/sig.f.",NpMethod,".",year.red,".RData", sep=""))
summary(np.f.sig)
@ 
...
theta1.tmp <-theta1[which(theta1!= -Inf)]    # rm infinite values  
